...
public class dreamloLeaderBoard : MonoBehaviour {
	...
	{
		Debug.Log ("Chamou funcao do dreamlo Tolisthightlow");
		Score[] scoreList = this.ToScoreArray();
		...
		Debug.Log ("Dreamlo listHighCores:" + genericList.Count);

		uiCon.updateLeaderBoardPanel (genericList);
